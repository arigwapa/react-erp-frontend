...
// Admin page for managing system users — supports
// viewing, searching, filtering, adding, editing,
// toggling status, and deleting user accounts.
// ==========================================
 ...
 * Each user has: id, name, email, role, branch, status, and lastLogin.
 ...
 * Used in the filter panel for Role, Branch, and Status filtering.
 * Props:
...
function UserManagementPage() {
  ...
  // 3A. STATE — Core Data
  // ------------------------------------------
  const [users, setUsers] = useState(INITIAL_USERS); // Master list of users
  ...
  const [branchFilter, setBranchFilter] = useState("All"); // Branch dropdown filter value
  ...
  // 3I. FILTERING LOGIC
  // ------------------------------------------
  // Filters users by search query (name or email) AND the selected Role/Branch/Status filters.
  ...
  return (
    <MainLayout>
      ...
      {/* Prompts user to confirm destructive actions (delete, disable) */}
      <ConfirmationModal
      ...
      <div className="space-y-6">
        {/* ---- 4C. PAGE HEADER ---- */}
        {/* Title, subtitle, and system status indicator */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 mt-2 text-xs font-medium">
              Manage system access, roles, and operational security.
            </p>
          </div>
        ...
        {/* Conditionally rendered when isFilterOpen is true.
            Contains dropdowns for Role, Branch, and Status filtering. */}
        {isFilterOpen && (
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 grid grid-cols-1 sm:grid-cols-3 gap-5 animate-in fade-in slide-in-from-top-2 z-10 relative">
            ...
            <ModernSelect
              ...
              options={["All", "Branch A", "Branch B", "Branch C"]}
        ...
        {/* Displays the paginated list of users with columns:
            User (avatar + name + email), Role, Branch, Status, Actions */}
                ...
                {paginatedUsers.length > 0 ? (
                  paginatedUsers.map((user) => (
                    ...
                    >
                      ...
                      {/* Column: Actions — Edit, Delete, and Toggle Switch */}
        ...
        {/* Full-screen overlay modal for creating or editing a user.
            ...
            Dropdowns use a custom ModernSelect-style component consistent with the filter panel. */}
          ...
          >
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              <form onSubmit={handleSaveUser} className="p-6 space-y-5">
                ...
                {/* Field 3: Role — Custom Dropdown (matches ModernSelect style) */}
                <ModalSelect
                  label="Role"
                  value={formData.role}
                ...
                {/* Field 4: Branch — Custom Dropdown (matches ModernSelect style) */}
                <ModalSelect
                  label="Branch"
