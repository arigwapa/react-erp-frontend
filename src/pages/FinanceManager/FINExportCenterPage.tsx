// ==========================================
// FINExportCenterPage.tsx
// Finance Manager — Export Center (Branch Only)
// Generate and download finance reports in PDF/Excel/CSV.
//
// Cards: Cost Summary, Budget Variance, Expense Breakdown,
//   Profit/Loss, COGS by Work Order, Period Financial Summary
...
/** Finance-specific exportable reports */
const ALL_REPORTS: ReportDefinition[] = [
  {
    id: "cost-summary",
    title: "Cost Summary Report",
    description:
      "Period cost summary with materials, labor, waste breakdown and total cost analysis.",
    icon: FileBarChart,
    lastExported: "Feb 13, 2026 · 03:45 PM",
  },
  {
    id: "budget-variance",
    title: "Budget Variance Report",
    description:
      "Budget vs actual with variance analysis, threshold alerts, and trend comparison.",
    icon: TrendingUp,
    lastExported: "Feb 12, 2026 · 10:20 AM",
  },
  {
    id: "expense-breakdown",
    title: "Expense Breakdown Report",
    description:
      "Detailed expense categorization by type, department, and cost center allocation.",
    icon: Receipt,
    lastExported: "Feb 11, 2026 · 02:30 PM",
  },
  {
    id: "profit-loss",
    title: "Profit/Loss Insights Report",
    description:
      "Revenue vs COGS analysis with margins, profitability trends, and product-level breakdown.",
    icon: PieChart,
    lastExported: "Feb 10, 2026 · 11:15 AM",
  },
  {
    id: "cogs-work-order",
    title: "COGS by Work Order Report",
    description:
      "Detailed cost breakdown per work order including materials, labor, and overhead allocation.",
    icon: ClipboardList,
    lastExported: null,
  },
  {
    ...
    description:
      "Locked period financial overview with consolidated totals, journal entries, and reconciliation.",
    icon: CalendarCheck,
    lastExported: "Feb 10, 2026 · 09:00 AM",
  },
];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mt-1">
                Generate and download finance reports — Manila Branch only
              </p>
            </div>
...
export default FINExportCenterPage;
