// ==========================================
// ProductionProfilePage.tsx — Production Manager Profile
...
function ProductionProfilePage() {
  ...
  // STATE: Profile
  // ------------------------------------------
  const [fullName, setFullName] = useState("Carlos Rivera");
  const [email, setEmail] = useState("carlos.rivera@weave-erp.com");
          ...
          <Card className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Production Manager · Manila Branch</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Production Manager</span>
                  </div>
                </div>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Sign out of your Production Manager session.</p>
              </div>
