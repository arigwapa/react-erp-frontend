...
// Production Manager — Export Center (Branch Only)
// Generate and download production reports in PDF/Excel/CSV.
//
// Cards: Production Plans, Work Orders, Completion & Handover,
//   Delay Analysis, Efficiency & Performance, Output vs Planned
...
/** Production-specific exportable reports */
const ALL_REPORTS: ReportDefinition[] = [
  {
    id: "production-plans",
    title: "Production Plans Report",
    description:
      "All production plans with status, dates, quantities, and resource allocation for the selected period.",
    icon: ClipboardList,
    lastExported: "Feb 12, 2026 · 04:30 PM",
  },
  {
    id: "work-orders",
    title: "Work Orders Summary",
    description:
      "Complete work order listing with progress, status, assigned quantities, and timeline tracking.",
    icon: Hammer,
    lastExported: "Feb 11, 2026 · 10:15 AM",
  },
  {
    id: "completion-report",
    title: "Completion & Handover Report",
    description:
      "Completed work orders with QA results, warehouse intake, and handover status details.",
    icon: PackageCheck,
    lastExported: "Feb 10, 2026 · 02:45 PM",
  },
  {
    id: "delay-analysis",
    title: "Delay Analysis Report",
    description:
      "Delayed work orders with root cause, days overdue, severity classification, and impact analysis.",
    icon: Clock,
    lastExported: "Feb 9, 2026 · 11:00 AM",
  },
  {
    id: "efficiency-report",
    title: "Efficiency & Performance Report",
    description:
      "Production line efficiency rates, output vs targets, utilization metrics, and trend analysis.",
    icon: TrendingUp,
    lastExported: null,
  },
  {
    id: "output-summary",
    title: "Output vs Planned Summary",
    description:
      "Comparison of planned quantity vs actual output per product, line, and period with variance data.",
    icon: BarChart3,
    lastExported: "Feb 8, 2026 · 09:30 AM",
  },
];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mt-1">
                Generate and download production reports — Manila Branch only
              </p>
            </div>
