// ==========================================
// AdminArchivesPage.tsx — Branch Admin Archives
// Archive for branch-scoped archived items (Branch A).
// Tabs: Users (branch), Products, Work Orders, Inspections, Inventory, Budgets
// ==========================================
...
// ==========================================
// TABS (no Branches — branch admin can't manage branches)
// ==========================================
const TABS = [
  ...
  { id: "budgets", label: "Budgets", icon: DollarSign, count: 3 },
];

// ==========================================
// MOCK ARCHIVED DATA (Branch A only)
// ==========================================
const ARCHIVED_USERS = [
  { id: 1, name: "Pedro Garcia", email: "pedro@erp.com", role: "PLM Manager", archivedDate: "Jan 10, 2026", archivedBy: "Admin User" },
  { id: 2, name: "Marco Reyes", email: "marco@erp.com", role: "Warehouse Manager", archivedDate: "Dec 20, 2025", archivedBy: "Admin User" },
  { id: 3, name: "Ana Santos", email: "ana@erp.com", role: "QA Lead", archivedDate: "Dec 15, 2025", archivedBy: "Admin User" },
  { id: 4, name: "Carlos Lim", email: "carlos@erp.com", role: "Production Supervisor", archivedDate: "Dec 10, 2025", archivedBy: "Admin User" },
];
...
const ARCHIVED_BUDGETS = [
  ...
  { id: 3, budgetName: "Branch A Q4 2025", amount: "$28,000", status: "Closed", period: "Q4 2025", archivedDate: "Dec 20, 2025", archivedBy: "Finance Manager" },
];
    ...
    <AdminLayout>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800">Branch Archives</h1>
            <p className="text-sm text-slate-500">View and manage archived records for your branch</p>
          </div>
        </div>
      </div>
