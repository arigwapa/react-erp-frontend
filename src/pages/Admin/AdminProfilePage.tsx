// ==========================================
// AdminProfilePage.tsx — Branch Admin Profile
...
function AdminProfilePage() {
  ...
  // STATE: Profile
  // ------------------------------------------
  const [fullName, setFullName] = useState("Mark Lee");
  const [email, setEmail] = useState("mark.lee@weave-erp.com");
        ...
        <div className="max-w-3xl mx-auto space-y-6 pb-20">
          ...
          <Card className="p-6">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white text-xl font-bold shadow-lg">
                ML
              </div>
              <div>
                <h2 className="text-lg font-bold text-slate-900 dark:text-white">{fullName}</h2>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Branch Admin · Manila Branch</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Branch Admin</span>
                  </div>
                </div>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Sign out of your Branch Admin session.</p>
              </div>
