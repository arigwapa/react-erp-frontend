...
// Collapsible sidebar navigation for the Production Manager panel.
// Features:
...
//   - Branch-scoped: only Production-related navigation
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: Archive,
        label: "Archives",
        path: "/production-manager/archives",
      },
    ],
  },
  {
