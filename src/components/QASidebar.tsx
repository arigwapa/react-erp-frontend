// ==========================================
// QASidebar.tsx
// Collapsible sidebar navigation for the Quality Manager panel.
// Features:
//   - Same expand/collapse behavior as ProductionSidebar.tsx
//   - Collapsible nav groups (dropdown sections)
//   - Auto-expands group containing the active route
//   - Branch-scoped: only QA-related navigation
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Bug, label: "Defect Management", path: "/qa-manager/defects" },
      {
        icon: CheckCircle2,
        label: "Approvals / Rejections",
        path: "/qa-manager/approvals",
      },
      { icon: ShieldAlert, label: "CAPA", path: "/qa-manager/capa" },
      {
        icon: ListChecks,
        label: "Quality Standards",
        path: "/qa-manager/checklists",
      },
      {
        icon: Archive,
        label: "Archives",
        path: "/qa-manager/archives",
      },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: Download, label: "Export Center", path: "/qa-manager/export" },
    ],
  },
];
