// ==========================================
// PLMSidebar.tsx
// Collapsible sidebar navigation for the PLM Manager panel.
// Features:
//   - Same expand/collapse behavior as AdminSidebar.tsx
//   - Collapsible nav groups (dropdown sections)
//   - Auto-expands group containing the active route
//   - PLM Manager + branch name indicator badge
//   - Branch-scoped: only PLM-related navigation
...
// PLM Manager-specific: Only PLM module pages
// ------------------------------------------
const menuGroups = [
  {
    label: "Overview",
  ...
  },
  {
    ...
    items: [
      {
        icon: Package,
        label: "Products (Styles & SKU)",
        path: "/plm-manager/products",
      },
      {
        icon: FileText,
        label: "Tech Pack & Versions",
        path: "/plm-manager/tech-pack",
      },
      {
        icon: Layers,
        label: "BOM (Bill of Materials)",
        path: "/plm-manager/bom",
      },
      {
        icon: BookOpen,
        label: "Materials Library",
        path: "/plm-manager/materials",
      },
      {
        icon: Rocket,
        label: "Release to Production",
        path: "/plm-manager/release",
      },
      {
        icon: Archive,
        label: "Archives",
        path: "/plm-manager/archives",
      },
    ],
  },
  {
    ...
    items: [
      {
        icon: BarChart3,
        label: "PLM Reports",
        path: "/plm-manager/reports",
      },
      {
        icon: Download,
        label: "Export Center",
        path: "/plm-manager/export",
      },
    ],
  },
];
